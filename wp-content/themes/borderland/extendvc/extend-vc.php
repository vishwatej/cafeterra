...
if (!eltd_vc_grid_elements_enabled() && version_compare(eltd_get_vc_version(), '4.4.2') >= 0) {
...
if (function_exists('vc_remove_param') && eltd_vc_grid_elements_enabled() && version_compare(eltd_get_vc_version(), '4.4.2') >= 0) {
...
vc_add_param("vc_gallery", array(
    "type" => "checkbox",
    "class" => "",
    "heading" => "Show image data?",
    "param_name" => "show_image_data",
    "value" => array("Show image data?" => "yes"),
    "description" => "",
...
vc_add_param("vc_gallery", array(
    "type" => "checkbox",
    "class" => "",
    "heading" => "Show image description?",
    "param_name" => "show_image_description",
    "value" => array("Show image description in the bottom of image" => "show_image_description"),
    "description" => "",
    "dependency" => Array('element' => "show_image_data", 'value' => array('yes'))
));
...
vc_add_param("vc_gallery", array(
    "type" => "checkbox",
    "class" => "",
    "heading" => "Show border around items",
    "param_name" => "show_border_around_items",
    "value" => array("Show border around items" => "yes"),
    "description" => "",
...
vc_add_param("vc_gallery", array(
    ...
    "holder" => "div",
    "class" => "",
    "heading" => "Title and Description Position",
...
vc_add_param("vc_gallery", array(
    ...
    "holder" => "div",
    "class" => "",
    "heading" => "Title and Desc Layer Color",
...
vc_add_param("vc_gallery", array(
    ...
    "holder" => "div",
    "class" => "",
    "heading" => "Description Font Style",
...
vc_add_param("vc_gallery", array(
    ...
    "holder" => "div",
    "class" => "",
    "heading" => "Description Layer Color",
...
vc_add_param("vc_text_separator", array(
    ...
    "description" => __("Insert border radius(Rounded corners) in px. For example: 4. Leave empty for default. ", 'eltd'),
    "dependency" => Array('element' => "text_in_box", 'value' => array('yes'))
));
...
vc_map( array(
	"name" =>  __( 'Elements Holder Item', 'eltd' ),
...
vc_map( array(
	'name' => __( 'Bordered Elements Holder', 'eltd' ),
	...
	'params' => array(
		array(
			...
			'value' => array(
				'No Animation' => '',
				'Continue Line' => 'eltd_box_continue_line',
				'Corner Line' => 'eltd_box_corner_line',
				'Simultaneous Line' => 'eltd_box_simultaneous_line'
			),
		...
		array(
			...
			'dependency' => array('element' => 'animation_type', 'value' => array('eltd_box_continue_line', 'eltd_box_corner_line', 'eltd_box_simultaneous_line'))
		),
		array(
			'type' => 'textfield',
			'holder' => 'div',
...
vc_map( array(
	"name" =>  __( 'Elated Vertical Split Slider', 'eltd' ),
...
vc_map( array(
	"name" =>  __( 'Left Sliding Panel', 'eltd' ),
...
vc_map( array(
	"name" =>  __( 'Right Sliding Panel', 'eltd' ),
...
vc_map( array(
	"name" =>  __( 'Slide Content Item', 'eltd' ),
...
for ($x = 1; $x<6; $x++) {
	$teamIconCollections = $eltdIconCollections->iconCollections;
...
vc_map( array(
	"name" => "Elated Process Holder", "eltd",
	"base" => "no_circles",
...
vc_map( array(
	...
	"params" => array_merge(
		...
		$eltdIconCollections->getVCParamsArray( array( 'element' => 'type', 'value' => array( 'icon_type' ) ) ),
		array(
			array(
				"type" => "textfield",
				"holder" => "div",
...
vc_map( array(
	"name" => "Elated Pricing Tables", "eltd",
...
vc_map( array(
		...
		"params" => array_merge(
			...
			$eltdIconCollections->getVCParamsArray(array("element" => "header_type", "value" => array("with_icon"))),
			array(
				array(
					"type" => "colorpicker",
					"holder" => "div",
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"param_name" => "padding",
			"value" => "0",
			"description" =>  __("Please insert padding in format (top right bottom left) i.e. 5px 5px 5px 5px", 'eltd')
		),
		array(
			"type" => "textfield",
			"holder" => "div",
...
vc_map( array(
		...
		"params" => array_merge(
                    ...
                    $eltdIconCollections->getVCParamsArray(array(), '', true),
                    array(
                        array(
                            "type" => "dropdown",
                            "class" => "",
                        ...
                        array(
                            ...
                            "heading" => "Margin",
                            "param_name" => "margin",
                            "description" => __("Please insert margin in format: 0px 0px 1px 0px", 'eltd')
                        ),
                        array(
                            "type" => "textfield",
                            "holder" => "div",
                        ...
                        array(
                            ...
                            "param_name" => "border_radius",
                            "description" => __("Please insert border radius(Rounded corners) in px. For example: 4 ", 'eltd')
                        )
                    )
                )
    )
...
vc_map( array(
	...
	"base" => "no_counter",
	"category" => 'by Elated',
	'admin_enqueue_css' => array(eltd_get_skin_uri().'/assets/css/eltdf-vc-extend.css'),
...
vc_map( array(
		...
		"params" => array(
			...
			array(
				...
				"heading" => "Content",
				"param_name" => "content",
				"value" => "15,#555,Legend One; 35,#222,Legend Two; 50,#303030,Legend Three",
				"description" => ""
			)
...
vc_map( array(
	...
	"params" => array_merge(
		...
		$eltdIconCollections->getVCParamsArray(),
		array(
			array(
				"type" => "colorpicker",
				"holder" => "div",
...
vc_map( array(
		...
		"params" => array(
			...
			array(
				...
				"heading" => "Content",
				"param_name" => "content",
				"value" => "#303030,Legend One,1,5,10;#222,Legend Two,3,7,20;#555,Legend Three,10,2,34"
			)
		)
) );
...
vc_map( array(
	...
	"params" => array_merge(
		...
		$eltdIconCollections->getSocialVCParamsArray(array(), '', false, 'linea_icons'),
		array(
			array(
				"type" => "dropdown",
				"holder" => "div",
...
vc_map( array(
		...
		"params" => array_merge(
                    ...
                    $eltdIconCollections->getVCParamsArray((array('element' => "show_icon", 'value' => array('always', 'on_hover'))), '', true),
                    array(
                        array(
                            "type" => "dropdown",
                            "holder" => "div",
